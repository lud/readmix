...
string(Ics) -> 
    string(Ics,{1,1}).
string(Ics,{L0,C0}) -> 
    string(Ics, L0, C0, Ics, []).
string(Ics, L0, C0, Tcs, Ts) -> 
    do_string(Ics, L0, C0, Tcs, Ts).
...
token(Cont,Chars) -> 
    token(Cont,Chars,{1,1}).
token(Cont, Chars, {Line,Col}) -> 
    do_token(Cont,Chars,Line,Col).
...
tokens(Cont,Chars) -> 
    tokens(Cont,Chars,{1,1}).
tokens(Cont, Chars, {Line,Col}) -> 
    do_tokens(Cont,Chars,Line,Col).
...
yystate(24, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(24, [C|Ics], Line, Col, Tlen, _, _) when C >= 98, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(24, Ics, Line, Col, Tlen, _, _) ->
    {6,Tlen,Ics,Line,Col,24};
...
yystate(21, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(21, Ics, Line, Col, Tlen+1, 8, Tlen);
yystate(21, [13|Ics], Line, Col, Tlen, _, _) ->
    yystate(21, Ics, Line, Col, Tlen+1, 8, Tlen);
yystate(21, [9|Ics], Line, Col, Tlen, _, _) ->
    yystate(21, Ics, Line, Col, Tlen+1, 8, Tlen);
...
yystate(17, [116|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(17, [102|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(17, [95|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(17, [36|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(17, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(17, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 97, C =< 101 ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(17, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 103, C =< 115 ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(17, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(14, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(14, Ics, Line, Col, Tlen+1, 7, Tlen);
...
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(13, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 35, C =< 91 ->
    yystate(13, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 93 ->
    yystate(13, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,13};
yystate(12, Ics, Line, Col, Tlen, _, _) ->
    {5,Tlen,Ics,Line,Col};
yystate(11, [45|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(11, [43|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(9, [114|Ics], Line, Col, Tlen, _, _) ->
...
yystate(9, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(9, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 113 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(9, [C|Ics], Line, Col, Tlen, _, _) when C >= 115, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(9, Ics, Line, Col, Tlen, _, _) ->
    {6,Tlen,Ics,Line,Col,9};
yystate(8, [115|Ics], Line, Col, Tlen, _, _) ->
...
yystate(8, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(8, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 114 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(8, [C|Ics], Line, Col, Tlen, _, _) when C >= 116, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(8, Ics, Line, Col, Tlen, _, _) ->
    {6,Tlen,Ics,Line,Col,8};
yystate(7, Ics, Line, Col, Tlen, _, _) ->
    {4,Tlen,Ics,Line,Col};
yystate(6, [92|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(6, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(13, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(13, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 35, C =< 91 ->
    yystate(13, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 93 ->
    yystate(13, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(2, [34|Ics], Line, Col, Tlen, _, _) ->
    yystate(5, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(2, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(13, Ics, Line+1, 1, Tlen+1, 2, Tlen);
yystate(2, [C|Ics], Line, Col, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(13, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(2, [C|Ics], Line, Col, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(13, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(2, [C|Ics], Line, Col, Tlen, _, _) when C >= 35, C =< 91 ->
    yystate(13, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(2, [C|Ics], Line, Col, Tlen, _, _) when C >= 93 ->
    yystate(13, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(2, Ics, Line, Col, Tlen, _, _) ->
    {2,Tlen,Ics,Line,Col,2};
yystate(1, [117|Ics], Line, Col, Tlen, _, _) ->
    yystate(0, Ics, Line, Col, Tlen+1, 6, Tlen);
...
yystate(1, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(1, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 116 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(1, [C|Ics], Line, Col, Tlen, _, _) when C >= 118, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(1, Ics, Line, Col, Tlen, _, _) ->
    {6,Tlen,Ics,Line,Col,1};
...
yyaction(2, TokenLen, YYtcs, TokenLine, TokenCol) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_2(TokenChars, TokenLen, TokenLine, TokenCol);
...
-file("rdmx_lexer.xrl", 22).
yyaction_0(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     to_token (float, TokenLoc, TokenChars, fun erlang : list_to_float / 1) .

-compile({inline,yyaction_1/3}).
-file("rdmx_lexer.xrl", 23).
yyaction_1(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     to_token (integer, TokenLoc, TokenChars, fun erlang : list_to_integer / 1) .

-compile({inline,yyaction_2/4}).
-file("rdmx_lexer.xrl", 24).
yyaction_2(TokenChars, TokenLen, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     unwrap_quoted (string, TokenLoc, TokenChars, TokenLen) .

-compile({inline,yyaction_3/3}).
-file("rdmx_lexer.xrl", 25).
yyaction_3(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     to_token (bool, TokenLoc, TokenChars, fun list_to_existing_atom / 1) .

-compile({inline,yyaction_4/2}).
-file("rdmx_lexer.xrl", 26).
yyaction_4(TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     to_token (':', TokenLoc) .

-compile({inline,yyaction_5/2}).
-file("rdmx_lexer.xrl", 27).
yyaction_5(TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     to_token ('/', TokenLoc) .

-compile({inline,yyaction_6/3}).
-file("rdmx_lexer.xrl", 28).
yyaction_6(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     to_binary_token (identifier, TokenLoc, TokenChars) .

-compile({inline,yyaction_7/3}).
-file("rdmx_lexer.xrl", 29).
yyaction_7(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     to_token (var, TokenLoc, TokenChars, fun variable_name / 1) .

-compile({inline,yyaction_8/0}).
-file("rdmx_lexer.xrl", 30).
yyaction_8() ->
     skip_token .

-compile({inline,yyaction_9/0}).
-file("rdmx_lexer.xrl", 31).
yyaction_9() ->
     skip_token .
