-file("rdmx_parser.yrl", 0).
-module(rdmx_parser).
-file("rdmx_parser.erl", 3).
-export([parse/1, parse_and_scan/1, format_error/1]).
-file("rdmx_parser.yrl", 42).
...
yeccpars2_8(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_namespace_function(hd(Nss), Cat, Nss, NewStack, T, Ts, Tzr).
...
yeccpars2_12(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_params_list(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).
...
yeccpars2_14(S, 'bool', Ss, Stack, T, Ts, Tzr) ->
...
yeccpars2_15(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_param_kv(hd(Nss), Cat, Nss, NewStack, T, Ts, Tzr).
...
yeccpars2_22(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_params_list(hd(Nss), Cat, Nss, NewStack, T, Ts, Tzr).
...
yeccgoto_command(0=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_3(_S, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_command(4=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_10(_S, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_namespace_function/7}).
-compile({nowarn_unused_function,  yeccgoto_namespace_function/7}).
yeccgoto_namespace_function(0, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_2(2, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_namespace_function(4, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_2(2, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_param_kv/7}).
-compile({nowarn_unused_function,  yeccgoto_param_kv/7}).
yeccgoto_param_kv(2, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_12(12, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_param_kv(12, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_12(12, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_params_list/7}).
-compile({nowarn_unused_function,  yeccgoto_params_list/7}).
yeccgoto_params_list(2=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_11(_S, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_params_list(12=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_22(_S, Cat, Ss, Stack, T, Ts, Tzr).
...
-file("rdmx_parser.yrl", 20).
yeccpars2_2_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
                                          with_params_tokens(___1, [])
  end | __Stack].

-compile({inline,yeccpars2_3_/1}).
-dialyzer({nowarn_function, yeccpars2_3_/1}).
-compile({nowarn_unused_function,  yeccpars2_3_/1}).
-file("rdmx_parser.yrl", 17).
...
-file("rdmx_parser.yrl", 24).
yeccpars2_8_(__Stack0) ->
 [___3,___2,___1 | __Stack] = __Stack0,
 [begin
                                                  {id_name(___1), id_name(___3)}
  end | __Stack].

-compile({inline,yeccpars2_9_/1}).
-dialyzer({nowarn_function, yeccpars2_9_/1}).
-compile({nowarn_unused_function,  yeccpars2_9_/1}).
-file("rdmx_parser.yrl", 23).
...
-file("rdmx_parser.yrl", 21).
yeccpars2_11_(__Stack0) ->
 [___2,___1 | __Stack] = __Stack0,
 [begin
                                            with_params_tokens(___1, ___2)
  end | __Stack].

-compile({inline,yeccpars2_12_/1}).
-dialyzer({nowarn_function, yeccpars2_12_/1}).
-compile({nowarn_unused_function,  yeccpars2_12_/1}).
-file("rdmx_parser.yrl", 26).
